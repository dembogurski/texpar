...
function actualizarCotizaciones(){
    ...
    load("caja/Cotizaciones.class.php",{usuario:usuario,session:session,suc:suc,desde:desde,hasta:hasta});
}
...
function guardarCotizacion(){              
    ...
    $.ajax({
        type: "POST",
        url: "caja/Cotizaciones.class.php",
        ...
        complete: function(objeto, exito) {
            if (exito == "success") { 
                ...
                setTimeout("actualizarCotizaciones()",5000); // Refresh                  
            }
        },
        error: function() {
